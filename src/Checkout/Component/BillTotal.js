        ...
        return (
            <div className = "order-products">
                <div className = "order-details__list">
                    <span className = "order-details__name">{p.pizzaName} </span>
                    <span className = "order-details__quantity">x{p.quantity}</span>
                </div>
        ...
        return (
            <div className = "order-subtotal">
                ...
                <div className = "float-cart__btn">
                    <span className = "cart-subtotal__sum">Order Total: ${util.formatPrice(
                        totalPrice
                    )}
                    </span>
                    <div className="float-cart__viewbtn">
                        PLACE ORDER  
                    </div>
                </div>
